...
execute @e[name=elereset] ~ ~ ~ kill @e[name=elesetup_east,dx=0,dy=256,dz=0]
...
summon armor_stand ~ ~ ~-1 {CustomName:"elesetup_east",NoGravity:1b,Invisible:1,Invulnerable:1,DisabledSlots:2039583}
...
setblock ~-1 ~3 ~3 air
setblock ~ ~3 ~3 minecraft:stone
setblock ~-1 ~3 ~3 minecraft:wall_sign 4 replace {Text1:"{\"text\":\"============\"}",Text2:"{\"text\":\"Awaiting Elevator\"}",Text3:"{\"text\":\"Setup...\"}",Text4:"{\"text\":\"============\"}"}
setblock ~ ~1 ~2 minecraft:structure_block 0 0 {metadata:"",mirror:"NONE",ignoreEntities:1b,powered:0b,seed:0L,author:"gshn28",rotation:"COUNTERCLOCKWISE_90",posX:0,mode:"LOAD",posY:0,posZ:0,integrity:1.0f,showair:0b,name:"elevator_model_modern",id:"Structure",showboundingbox:0b}
