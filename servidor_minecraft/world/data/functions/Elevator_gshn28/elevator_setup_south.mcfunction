...
execute @e[name=elereset] ~ ~ ~ kill @e[name=elesetup_south,dx=0,dy=256,dz=0]
...
summon armor_stand ~-1 ~ ~ {CustomName:"elesetup_south",NoGravity:1b,Invisible:1,Invulnerable:1,DisabledSlots:2039583}
...
setblock ~-2 ~3 ~-1 air
setblock ~-2 ~3 ~ minecraft:stone
setblock ~-2 ~3 ~-1 minecraft:wall_sign 2 replace {Text1:"{\"text\":\"============\"}",Text2:"{\"text\":\"Awaiting Elevator\"}",Text3:"{\"text\":\"Setup...\"}",Text4:"{\"text\":\"============\"}"}
setblock ~2 ~1 ~ minecraft:structure_block 0 0 {metadata:"",mirror:"NONE",ignoreEntities:1b,powered:0b,seed:0L,author:"gshn28",rotation:"NONE",posX:-3,mode:"LOAD",posY:0,posZ:0,integrity:1.0f,showair:0b,name:"elevator_model_modern",id:"Structure",showboundingbox:0b}
